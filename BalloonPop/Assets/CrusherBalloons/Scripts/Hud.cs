    ...
    void OnGUI()
    {
        ...
        if (menuScript.gameStarted)
        {
            if (!scoreScript.disableHud)
            {
                ...
                GUI.Label(new Rect(Screen.width - 70, 0, 200, 100), "" + objectiveScore, blueFont.label);
                GUI.Label(new Rect(Screen.width - 90, 28, 200, 100), "Lvl:" + menuScript.level, blackFont.label);
                GUI.Label(new Rect(Screen.width - 90, 26, 200, 100), "Lvl:" + menuScript.level, blueFont.label);
            ...
            if (scoreScript.once)
            {
                GUI.Label(new Rect(Screen.width / 2 - 10, 80, 200, 150), "" + scores, blueFont.label);
                /*if (Screen.currentResolution.width == 854 || Screen.currentResolution.width == 800)
                {
